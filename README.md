...
## 🖼 实验三：圆锥曲线画板（2026-08-28 新增）

- 椭圆 / 双曲线 / 抛物线一键切换，焦点（F₁/F₂）、准线、渐近线实时绘制
- 动点 P 沿曲线行走，芯片实时验证定义：|PF₁|+|PF₂|=2a、||PF₁|−|PF₂||=2a、|PF|=准线距离
- 参数滑块（半长轴/半短轴/焦准距）+ 离心率/焦点距实时数值卡
- 公式卡（标准方程/定义/离心率）、三类型专属易错点、挑战 4 题自动判分
- 「解析几何」模块开放免费体验
